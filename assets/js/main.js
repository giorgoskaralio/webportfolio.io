...
window.onload = function() {
    ...
    // Calculate and set the top and left offsets to center the modal
    ...
    // Optional: If using a button to "Continue to Website" and close the modal
    var continueBtn = document.querySelector('.modal-content .button');
